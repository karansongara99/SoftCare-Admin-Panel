...
import { AddSubTreatmentTypeAction } from "@/app/action/subtreatmenttype/AddActionSubTreatmentType";

export default async function AddSubTreatmentType() {
    const treatmenttypes = await prisma.mst_treatment_type.findMany();

    return (
        <>
            <div className="pagetitle">
                <h1>Add Sub Treatment Type</h1>
                <nav>
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active">Add Sub Treatment Type</li>
                    </ol>
                </nav>
            </div>
            {/* End Page Title */}
                    ...
                    <div className="col-lg-12">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">Add Sub Treatment Type</h5>
                                {/* General Form Elements */}
                                <form action={AddSubTreatmentTypeAction}>
                                    <div className="row mb-3">
                                        <label htmlFor="SubTreatmentTypeName" className="col-sm-2 col-form-label">
                                            Sub Treatment Type Name
                                        </label>
                                        <div className="col-sm-10">
                                            <input type="text" name="SubTreatmentTypeName" className="form-control" required />
                                        </div>
                                    </div>
                                    <div className="row mb-3">
