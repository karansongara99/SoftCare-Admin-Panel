                        ...
                        <div className="row">
                            ...
                            <div className="col-xxl-4 col-md-6">
                                <div className="card info-card sales-card">
                                    ...
                                    <div className="card-body">
                                        <h5 className="card-title">OPD Visits Today</h5>
                                        ...
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="ps-3">
                                                <h6>78</h6>
                                                <span className="text-success small pt-1 fw-bold">10%</span>
                            ...
                            <div className="col-xxl-4 col-md-6">
                                <div className="card info-card revenue-card">
                                    ...
                                    <div className="card-body">
                                        <h5 className="card-title">OPD Revenue</h5>
                                        ...
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="ps-3">
                                                <h6>₹14,850</h6>
                                                <span className="text-success small pt-1 fw-bold">6%</span>
                                                <span className="text-muted small pt-2 ps-1">increase</span>
                                            </div>
                                        </div>
                                ...
                                <div className="card info-card customers-card">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="ps-3">
                                                <h6>32</h6>
                                                <span className="text-danger small pt-1 fw-bold">5%</span>
